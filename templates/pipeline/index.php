...
<div class="card pipeline-board">
  <?php if (($pipelineStagesAvailable ?? true) === false): ?>
    <p class="muted">Pipeline non initialisé : table <code>pipeline_stages</code> absente. Exécutez la migration SQL pour activer le board.</p>
  <?php else: ?>
...
<div class="card">
  <p class="muted">Pipeline mobile-first actif · <?= (int) $stageCount ?> prospects visibles.</p>
</div>
